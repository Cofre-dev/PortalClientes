...
class DocumentController {
    ...
    public function delete($id) {
        ...
        if ($userData['role'] !== 'admin' && ($documento['subido_por_cliente'] != true || $documento['cliente_id'] != $userData['cliente_id'])) {
    ...
    public function rename($id) {
        ...
        if (empty($nuevoNombre)) {
            http_response_code(400);
            echo json_encode(['error' => 'El nuevo nombre es requerido']);
            return;
        }
        ...
        // Solo el cliente que subió puede renombrar (o admin)
        if ($userData['role'] !== 'admin' && ($documento['subido_por_cliente'] != true || $documento['cliente_id'] != $userData['cliente_id'])) {
            http_response_code(403);
        ...
        $nombreCompleto = $nuevoNombre . ($extension ? '.' . $extension : '');
